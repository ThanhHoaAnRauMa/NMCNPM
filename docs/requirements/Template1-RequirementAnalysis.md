...
| --- | --- | --- |
| 1 | Người dùng cuối (End User / Client) | Bao gồm người dùng ưu tiên quyền riêng tư (đăng ký bằng ví Web3/ẩn dan`h) và người dùng định danh. Họ sử dụng hệ thống để nhắn tin 1-1, gọi điện, tạo nhóm, quản lý danh tính và sử dụng các tính năng forensics (ký số tin nhắn, gửi dispute, xuất bằng chứng) để bảo vệ quyền lợi cá nhân hoặc công việc [2, 4, 5]. |
